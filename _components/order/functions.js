...
export const handlePaymentText = (payment_type, status, fields) => {
  ...
  if (status === "success") {
    data_tmp = {
      ...
      text_line_1: null,
      text_line_2:
        "Za sve dodatne informacije možete nas kontaktirati putem call centra +381 32 49 32 412 ili putem emaila office@maximon.rs",
    ...
    data_tmp = {
      title: "Vaša narudžbenica je uspešno kreirana, ali plaćanje nije uspelo. Uskoro ćemo Vas kontaktirati",
      subtitle: "Hvala Vam na ukazanom poverenju.",
      image: "/images/uspesno.png",
      text_line_2:
        "Za sve dodatne informacije možete nas kontaktirati putem call centra +381 32 49 32 412 ili putem emaila office@maximon.rs",
