...
const Povracaj = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (errors.length > 0) {
            ...
            await POST("contact/contact_page", {
                ...
                company_sector: "",
                message: `Odustajanje od robe: ${formData?.message
                    } \n Datum zaključenja ugovora: ${convertDate(
                        formData?.date_of_contract
                    )} \n Datum prijema robe: ${convertDate(
                        formData?.date_of_arrival
                    )} \n Razlozi za odustanak: ${formData?.reasons_of_return
                    } \n Ime i prezime potrošača: ${formData?.full_name
                    } \n Broj lične karte: ${formData?.id_number} \n Adresa potrošača: ${formData?.address
                    } \n Broj tekućeg računa potrošača: ${formData?.bank_account
    ...
    return (
        <Provider reCaptchaKey={process.env.CAPTCHAKEY}>
            ...
            <div className="w-[90%] mx-auto 2xl:w-[85%] prose !max-w-full text-base font-normal leading-tight mt-20">
                    ...
                    >
                        ...
                        <div className={`mt-5 col-span-1 md:col-span-2 flex flex-col`}>
                            ...
                            <textarea
                                ...
                                rows={4}
                                className={`mt-1 w-full ${errors.includes("message")
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`mt-1 w-full ${errors.includes("date_of_contract")
                                    ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                    : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                    }`}
                            />
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className={`mt-1 w-full ${errors.includes("date_of_arrival")
                                    ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                    : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                    }`}
                            />
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                ...
                                name={`full_name`}
                                onChange={handleChange}
                                className={`mt-1 w-full ${errors.includes("full_name")
                                    ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                    : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                    }`}
                            />
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                ...
                                name={`id_number`}
                                onChange={handleChange}
                                className={`mt-1 w-full ${errors.includes("id_number")
                                    ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                    : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                    }`}
                            />
                        ...
                        <div className={`col-span-1 flex flex-col items-start`}>
                            ...
                            <input
                                ...
                                name={`today_date`}
                                onChange={handleChange}
                                className={`mt-1 w-full ${errors.includes("today_date")
                                    ? "border border-red-500  focus:border-red-500 focus:ring-0 focus:outline-0"
                                    : "border border-[#e0e0e0] focus:border-[#e0e0e0] focus:ring-0 focus:outline-0"
                                    }`}
                            />
