    ...
    <>
      <div className={`col-span-2 lg:col-span-1`}>
        <div className={`flex flex-col gap-5`}>
          <div className={`bg-[#f7f7f7] pb-8 pt-3 pl-3`}>
            <h3
              className={`pb-4  text-[14px] font-normal text-black/70 ${
                className ? className : ""
              } uppercase underline ${
              ...
              return (
                <div className={`flex flex-col gap-2 pl-2.5`} key={id}>
                  <div className={`flex items-center gap-3`} key={id}>
                    <input
                      type={`radio`}
                      className={`cursor-pointer text-black focus:text-black focus:outline-none focus:ring-0 hover:bg-black`}
                    ...
                    <label
                      ...
                      className={`cursor-pointer text-[14px] font-light ${className}`}
                    >
                      {name}
                    </label>
                  </div>
          ...
          <div className={`bg-[#f7f7f7] pb-8 pt-3 pl-3`}>
            <h3
              className={`pb-4 text-[14px] font-normal text-black/70  ${className} uppercase underline ${
