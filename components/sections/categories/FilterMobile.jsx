  ...
  return (
    <>
      <div className="h-full flex flex-col px-[0.7rem]">
        ...
        >
          <h1 className="text-[#171717] self-center mx-auto font-normal text-black/70 text-center text-[1rem]">
            Filteri
          </h1>
          <i
        ...
        <div className="flex w-[95%] mx-auto flex-col border-b border-b-[#f5f5f5] py-[23px] overflow-hidden">
          ...
          >
            <h1 className="text-[1rem] font-normal text-black/70">Sortiranje</h1>
            ...
            >
              {sortKeys?.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <p className="font-normal text-black/70 text-[13px]">{item?.label}</p>
                  </div>
                );
              })}
            </div>
          ...
          return (
            <div key={index}>
              <div
                ...
                key={filter?.key}
              >
                <h1 className="text-[1rem] font-normal text-black/70 ">
        ...
        >
          ...
          >
            <h1 className={`text-[1.2rem] font-normal text-black/70 text-center py-3`}>
              Resetuj
            </h1>
          </button>
          <button
